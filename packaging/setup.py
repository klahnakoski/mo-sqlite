...
setup(
    ...
    install_requires=["jx-python==4.497.24022","mo-dots","mo-files","mo-future","mo-imports","mo-json","mo-kwargs","mo-logs","mo-math","mo-sql==4.492.24021","mo-sql==4.492.24021","mo-threads","mo-times"],
    license='MPL 2.0',
